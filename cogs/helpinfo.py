...
class HelpInfo(commands.Cog):
    ...
    async def info_command(self, ctx):
        ...
        embed.add_field(
            ...
            inline=False)
        embed.add_field(
            name='<:Mentorbot:640465696869974017> [Add Mentorbot to your own server](https://discordapp.com/api/oauth2/authorize?client_id=475596740368793600&permissions=134522944&scope=bot):',
